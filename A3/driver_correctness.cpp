...
#elif defined ONE_LOCK_STACK
#include "stacks/one_lock_stack.h"
OneLockStack<int> my_queue;
#elif defined LOCK_FREE_STACK
#include "stacks/lock_free_stack.h"
LockFreeStack<int> my_queue;
#else
#include "queues/non_blocking_queue.h"
NonBlockingQueue<int> my_queue;
#endif
...
struct ProducerWithInputs
{
    ...
    void operator()()
    {
        ...
        {
#if defined LOCK_FREE_STACK || ONE_LOCK_STACK
            my_queue.push(inputs_[i]);
#else
